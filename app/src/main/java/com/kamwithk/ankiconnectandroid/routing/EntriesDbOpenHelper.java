...
public class EntriesDbOpenHelper extends SQLiteOpenHelper {
    // If you change the database schema, you must increment the database version.
    public static final int DATABASE_VERSION = 1;
    public static final String DATABASE_NAME = "entries.db";

    public EntriesDbOpenHelper(Context context) {
        // this statement is ugly because super() must be called first (can't assign a temporary variable)
