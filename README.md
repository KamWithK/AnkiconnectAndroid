    ...
    * Ensure `Scanning Inputs` is optimized for mobile (prevents lookups on scrolling):
        ...
        * Navigate to `Scanning` → `Configure advanced scanning inputs`
            ...
            *   <details> <summary>Match your settings to be like this image: <i>(click here)</i></summary>
                <a href="https://github.com/KamWithK/AnkiconnectAndroid/blob/master/img/scanning_inputs.jpg"><img src="https://github.com/KamWithK/AnkiconnectAndroid/blob/master/img/scanning_inputs.png" width="400" /></a>
                </details>
